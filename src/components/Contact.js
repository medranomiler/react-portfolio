...
function Contact(){
  ...
  <div class="mb-6">
    <label htmlFor="name" class="block mb-2 text-sm font-medium text-slate-50">Your name</label>
  ...
  <div class="mb-6">
    <label htmlFor="email" class="block mb-2 text-sm font-medium text-slate-50">Your email</label>
    <input ref={emailRef} type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="name@gmail.com" required />
            ...
            <label htmlFor="message" class="block mb-2 text-sm font-medium text-slate-50">Your message</label>
            ...
            <button type="submit" class="mt-3 text-white bg-black hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
            </form>
        </main>
        </div>
)
